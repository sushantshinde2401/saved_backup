...
function ProformaInvoice() {
  ...
  const STORAGE_KEYS = {
      INVOICE_DATA: 'proforma_invoice_data',
      SELECTED_DATE: 'proforma_selected_date',
      OPTIONAL_FIELDS: 'proforma_optional_fields',
      VISIBLE_FIELDS: 'proforma_visible_fields',
      TOTAL_AMOUNT: 'proforma_total_amount'
  };
  ...
  const loadPersistedData = () => {
       try {
           ...
           const persistedTotalAmount = localStorage.getItem(STORAGE_KEYS.TOTAL_AMOUNT);
           ...
           return {
               ...
               totalAmount: persistedTotalAmount ? parseFloat(persistedTotalAmount) : 0
           };
       } catch (error) {
  ...
  useEffect(() => {
    saveToLocalStorage(STORAGE_KEYS.TOTAL_AMOUNT, totalAmount);
  }, [totalAmount]);
    ...
    <>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Non-GST invoice layout</p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
      ...
      <div className="flex gap-6 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-2 bg-white px-4 py-2">
          <h1 className="text-3xl font-bold text-gray-800 tracking-wide">PROFORMA INVOICE</h1>
        </div>
          ...
          <table className="w-full border-collapse border border-gray-400 text-xs">
            ...
            <tbody>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="border border-gray-400 p-1 text-right font-semibold text-xs">{totalAmount.toLocaleString()}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="mb-3 text-xs">
          ...
          <div className="mt-1">
            <strong>Total Amount: ₹{totalAmount.toLocaleString()}</strong><br />
