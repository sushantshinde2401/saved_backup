...
function CompanyDetailsStep({ formData, onInputChange, loadingCompanyDetails, companyAccounts }) {
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <Building className="w-16 h-16 text-green-600 mx-auto mb-4" />
        <h3 className="text-2xl font-bold text-gray-800 mb-2">Company Details</h3>
        <p className="text-gray-600">Enter your company information for the invoice</p>
      </div>
