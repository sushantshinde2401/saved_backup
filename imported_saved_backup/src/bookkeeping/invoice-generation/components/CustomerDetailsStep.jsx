...
function CustomerDetailsStep({ formData, onInputChange, customers }) {
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <Users className="w-16 h-16 text-blue-600 mx-auto mb-4" />
        <h3 className="text-2xl font-bold text-gray-800 mb-2">Customer Details</h3>
        <p className="text-gray-600">Add customer information for the invoice</p>
      </div>
