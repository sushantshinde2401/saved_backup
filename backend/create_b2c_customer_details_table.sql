...
CREATE INDEX IF NOT EXISTS idx_b2c_candidate_id ON b2c_customer_details(candidate_id);
...
COMMENT ON COLUMN b2c_customer_details.candidate_id IS 'Foreign key reference to candidates table';
