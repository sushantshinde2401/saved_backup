"""
Database configuration using SQLAlchemy for Neon PostgreSQL
Provides production-safe database connection with connection pooling and proper session management.
"""
