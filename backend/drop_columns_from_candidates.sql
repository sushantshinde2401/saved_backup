...
-- This script removes the following columns: certificate_selections, is_current_candidate, is_certificate_selection, companyname
...
ALTER TABLE candidates DROP COLUMN IF EXISTS certificate_selections CASCADE;
