...
-- Alter phone_number column to VARCHAR(255) if it exists and is shorter
DO $$
BEGIN
    IF EXISTS (
...
-- Insert actual B2B customer data from Excel file
...
(NULL, NULL, 'KSC', '+91 89764 85741', 'kscservices2021@gmail.com', NULL, NULL, NULL, NULL, NULL),
...
(NULL, NULL, 'ABHISHEK BONGAL', '+91 98214 29969', 'abhishekbhogwal@gmail.com', NULL, NULL, NULL, NULL, NULL),
...
(NULL, NULL, 'SANDEEP RAJARSHI', '+91 99342 15283', NULL, 'MAHALAKSMI, MUMBAI', 'mumbai', 'Maharashtra', '27', '400011'),
...
(NULL, NULL, 'PADDY BP MARINE', '82913 96549', 'NA', NULL, NULL, NULL, NULL, NULL),
...
(NULL, NULL, 'MSC', '+91 2266378000', 'ind-info@msc.com', 'SANDESH SIR  ANDHERI', 'mumbai', 'Maharashtra', '27', NULL),
...
BEGIN
    ...
    RAISE NOTICE 'Total B2B customers in database after insertion: %', inserted_count;
END $$;